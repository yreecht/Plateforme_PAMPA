#-*- coding: latin-1 -*-
# Time-stamp: <2018-08-30 12:27:21 yreecht>
...
source("./Scripts_Biodiv/Traces_tortues.R", encoding="latin1")                         # OK [mld]

## ...la sélection des données :
source("./Scripts_Biodiv/Selection_donnees.R", encoding="latin1")                      # OK [mlo]
