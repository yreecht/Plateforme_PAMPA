#-*- coding: latin-1 -*-
# Time-stamp: <2019-02-04 01:44:35 yreecht>
...
selectModWindow.f <- function(champ, data, selectmode="multiple", sort=TRUE, preselect=NULL, title=NULL, label=NULL)
{
    ...
    {
        tkgrid(tklabel(winfac, text=mltext("selectModWindow.f.CB.3")), columnspan=2)
    }else{}
...
titreSelVar.f <- function(type, nextStep)
{
    ...
    texts <- list(
                  ...
                  factSep=c(boxplot.esp = paste0(mltext("titreSelVar.f.FS.graphFact"),
                                                 paste(aliases(fieldID = c("species.code",
                                                                           "scient.name")),
                                                       collapse = paste0("' ", mltext("KW.or"), " '")),
                                                 mltext("titreSelVar.f.FS.spRecommended")),
                            modele_lineaire = paste0(mltext("titreSelVar.f.FS.modele_lineaire"),
                                                     paste(aliases(fieldID = c("species.code",
                                                                               "scient.name")),
                                                           collapse = paste0("' ", mltext("KW.or"), " '")),
                                                     mltext("titreSelVar.f.FS.spRecommended")),
                            freq_occurrence = paste0(mltext("titreSelVar.f.FS.freq_occurrence"),
                                                     paste(aliases(fieldID = c("species.code",
                                                                               "scient.name")),
                                                           collapse = paste0("' ", mltext("KW.or"), " '")),
                                                     mltext("titreSelVar.f.FS.spRecommended")),
                            ...
                            MRT.esp = paste0(mltext("titreSelVar.f.FS.MRT.esp"),
                                             paste(aliases(fieldID = c("species.code",
                                                                       "scient.name")),
                                                   collapse = paste0("' ", mltext("KW.or"), " '")),
                                             mltext("titreSelVar.f.FS.spRecommended")),
                            barplot.unitobs=mltext("titreSelVar.f.FS.selectSp"),
                            barplot.esp = paste0(mltext("titreSelVar.f.FS.graphFact"),
                                                 paste(aliases(fieldID = c("species.code",
                                                                           "scient.name")),
                                                       collapse = paste0("' ", mltext("KW.or"), " '")),
                                                 mltext("titreSelVar.f.FS.spRecommended")),
                            spBarBoxplot.unitobs=mltext("titreSelVar.f.FS.selectSp"),
                            spBarBoxplot.esp = paste0(mltext("titreSelVar.f.FS.graphFact"),
                                                      paste(aliases(fieldID = c("species.code",
                                                                                "scient.name")),
                                                            collapse = paste0("' ", mltext("KW.or"), " '")),
                                                      mltext("titreSelVar.f.FS.spRecommended")),
                            spSymbols.unitobs=mltext("titreSelVar.f.FS.selectSp"),
                            spSymbols.esp = paste0(mltext("titreSelVar.f.FS.graphFact"),
                                                   paste(aliases(fieldID = c("species.code",
                                                                             "scient.name")),
                                                         collapse = paste0("' ", mltext("KW.or"), " '")),
                                                   mltext("titreSelVar.f.FS.spRecommended"))),
...
selectionVariables.f <- function(nextStep, dataEnv, baseEnv)
{
    ...
    tkwm.title(WinSelection,
               paste(switch(nextStep,
                            "freq_occurrence"=,
                            "freq_occurrence.unitobs"={
                                mltext("selectionVariables.Occ.WT")
                            },
                            mltext("selectionVariables.WT")),
