...
# Type              : Programme
# Objet             : Fonctions diverses directement liées à la gestion des 
#                     différentes interfaces  (aspect, position, etc.)C
# Input             : aucun
                      ...
                      }, titleType="load",...)
{
    ...
    ##            icon : icone à afficher à gauche du texte.
...
tkObj.gridInfo.f <- function(tkObj)
{
    ...
    ##          Renvoie les différentes options de placement de l'objet
    ## ----------------------------------------------------------------------
