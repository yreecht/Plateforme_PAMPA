################################################################################
# Nom               : InterfaceFrequentation.r
# Type              : Programme
# Objet             : Fonctions permettant de créer l'interface pour les calculs
#                     et le lancement des graphiques relatifs aux données de fréquentation.
#                     Cette interface permet à l'utilisateur de faire ses choix pour les calculs 
# Input             : clic souris
...
listeZones.f <- function(nivSpatial, ...)
{
    ...
    ## ----------------------------------------------------------------------
    ## Arguments: nivSpatial : niveau spatial choisi
    ## ----------------------------------------------------------------------
    ## Author: Elodie Gamp, Date: 15 sept. 2011
