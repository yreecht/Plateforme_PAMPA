...
# Type              : Programme
# Objet             : Teste s'il manque des packages pour l'éxécution des scripts Usages.
...
loadPackages.f <- function() {
    ...
    ## Packages nécessaires au bon fonctionnement de la plateforme PAMPA Usages stats :
