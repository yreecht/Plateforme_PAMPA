...
source("C:/PAMPA/Scripts_Usages/PackagesManquants.r")
...
source("C:/PAMPA/Scripts_Usages/InterfaceFonctions.r")
# Script des fonctions graphique d'enquêtes
source("C:/PAMPA/Scripts_Usages/FonctionsGraphEnquetes.R")
# script des fonctions d'interface des données d'enquêtes
source("C:/PAMPA/Scripts_Usages/InterfaceEnquetes.r")
# Script des fonctions graphique de fréquentation
source("C:/PAMPA/Scripts_Usages/FonctionsGraphFrequentation.r")
# script des fonctions d'interface des données de fréquentation
source("C:/PAMPA/Scripts_Usages/InterfaceFrequentation.r")
# Script des fonctions génériques d'extrapolation
source("C:/PAMPA/Scripts_Usages/FonctionsExtrapolation.r")
# Script des fonctions d'interface d'extrapolation
source("C:/PAMPA/Scripts_Usages/InterfaceExtrapolation.r")
# Script des fonctions de bootstrap d'extrapolation
source("C:/PAMPA/Scripts_Usages/BootstrapFrequentationExtrapolee.r")
# Script des fonctions bootstrap (enquêtes)
source("C:/PAMPA/Scripts_Usages/BootstrapEnquetes.r")
# Script des fonctions de calcul d'indices composites (enquêtes pêche)
source("C:/PAMPA/Scripts_Usages/CalculIndicateurComposite.r")
# Script des fonctions de calcul de fréquentation selon la météo
source("C:/PAMPA/Scripts_Usages/FonctionsFreqMeteo.r")

# Script des fonctions statistiques de base
source("C:/PAMPA/Scripts_Usages/TestsStatsFonctionsBase.r")
# Script des fonctions statistiques pour la fréquentation
source("C:/PAMPA/Scripts_Usages/TestsStatistiquesFreq.r")
# Script des fonctions d'interface des statistiques de fréquentation
source("C:/PAMPA/Scripts_Usages/InterfaceStatsFreq.r")
# Script des fonctions statistiques pour les enquêtes
source("C:/PAMPA/Scripts_Usages/TestsStatistiquesEnquetes.r")
# Script des fonctions d'interface des statistiques des enquêtes
source("C:/PAMPA/Scripts_Usages/InterfaceStatsEnquetes.r")

# Script des informations constituant la rubrique A propos de l'interface
source("C:/PAMPA/Scripts_Usages/InfoApropos.r")

# Script de choix de l'utilisateur
#source("C:/PAMPA/Scripts_Usages/ChoixUtilisateur.r")
...
tcl("image","create","photo",imageAMP,file="C:/PAMPA/Scripts_Usages/img/pampa2.GIF")
...
EtudeFrequentation <- tkmenu(topMenu,tearoff=FALSE,bg="lightsalmon")
EtudeEnquete <- tkmenu(topMenu,tearoff=FALSE,bg="lightsalmon")
...
# Menu déroulant des choix disponibles pour la fréquentation
  tkadd(EtudeFrequentation,"command",label="Calculs et graphiques de fréquentation", command = function() interfaceFrequentation.f())
  tkadd(EtudeFrequentation,"command",label="Tests statistiques de la fréquentation", command = function() interfaceStatsFrequentation.f())
  tkadd(EtudeFrequentation,"command",label="Fréquentation selon les facteurs météo", command = function() interfaceMeteo.f())
  
# Menu déroulant des choix disponibles pour les enquêtes
  tkadd(EtudeEnquete,"command",label="Calculs et graphiques des enquêtes", command = function() interfaceEnquete.f())
  tkadd(EtudeEnquete,"command",label="Tests statistiques des enquêtes", command = function() interfaceStatsEnquete.f())

######################## Premier niveau de menu ################################

  tkadd(topMenu,"command",label="Import des données",command = function() source("C:/PAMPA/Scripts_Usages/ImportDonnees.r"))
  tkadd(topMenu,"cascade",label="Etude de la fréquentation", menu = EtudeFrequentation)
  tkadd(topMenu,"cascade",label="Etude des enquêtes", menu = EtudeEnquete)
  tkadd(topMenu,"command",label="Extrapolation de la fréquentation", command = interfaceExtrapolation.f)
  tkadd(topMenu,"command",label="Indices composites", command = function() CalculIndicateurCompo.f  (tab = peche)) #IndiceCompo)
  tkadd(topMenu,"command",label="A propos", command = function() apropos.f())
