...
tkadd(outils, "command", label="mise à jour (site de téléchargement)", state="normal",
      command = function()
  {
      browseURL("http://pampa:pampa@www.projet-pampa.fr/wiki/doku.php/wp2:telechargement")
  })
...
tkadd(pampainfos, "command", label="Documentation en ligne",
      command = function()
  {
      browseURL("http://pampa:pampa@www.projet-pampa.fr/wiki/doku.php/wp2:wp2#documentation")
  })
...
tkadd(pampainfos, "command", label="Forum d'entraide",
      command = function()
  {
      browseURL("http://pampa:pampa@www.projet-pampa.fr/forum/viewforum.php?id=2")
  })
